...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-12 use-case-text text-center">
			...
			<div class="grofers-anything display-first"
	...
	<div id="append-data" class="row">
		<div class="center-block text-center" id="phone-number-container">
			<i title="Enter your mobile number"
				class="grofers-social-icon fa fa-mobile fa-lg"></i>
			...
			<button title="and chill" id="get-app-button" type="button"
				class="grofers-get-app btn" data-toggle="modal"
		...
		<div class="row top-buffer-20 text-center call-grofers">
			Call us on&nbsp;&nbsp;&nbsp;<a class="grofers-phone"
