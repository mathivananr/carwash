...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.carwash.service.impl.PasswordTokenManager#generateRecoveryToken(com.carwash.model.User)
     */
    @Override
    ...
    /**
     * @see com.carwash.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.carwash.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.carwash.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
